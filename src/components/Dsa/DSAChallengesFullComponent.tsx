...
interface DSAChallengesFullComponentProps {
	onBack: () => void;
}
...
const achievements = [
	...
	},
	{
		id: 2,
		title: "Speed Demon",
		description: "Solve 3 challenges in under 20 minutes each",
		icon: "⚡",
		unlocked: true,
	},
	{
		id: 3,
		title: "Tree Explorer",
		description: "Complete all tree-related challenges",
		icon: "🌳",
		unlocked: false,
	},
	{
		id: 4,
		title: "Hash Master",
		description: "Master all hashing challenges",
		icon: "#️⃣",
		unlocked: false,
	},
	{
		...
		description: "Complete all challenges with optimal solutions",
		icon: "🧠",
		unlocked: false,
	},
];

export default function DSAChallengesFullComponent({
	onBack,
						...
						<div className="flex items-center space-x-4">
							...
							<div>
								...
								<p className="text-muted-foreground">
									Test your algorithm skills with hands-on problems
								</p>
							</div>
						</div>
										...
										<CardHeader className="pb-4">
											...
											<div className="flex flex-wrap gap-2 mt-3">
												<Badge
													className={
														categoryColors[
															challenge.category as keyof typeof categoryColors
														]
													}
												>
													{challenge.category}
							...
							<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
								{achievements.map((achievement) => (
									<Card
										key={achievement.id}
										className={`${
											achievement.unlocked ? "border-success bg-success/5" : "opacity-60"
										}`}
									>
