				...
				<div className="container mx-auto px-4">
					<div className="max-w-4xl mx-auto text-center space-y-6">
						...
						<h1 className="text-4xl md:text-6xl font-bold leading-tight">
							Master DSA
							<span className="block text-secondary">Visualize & Practice</span>
						</h1>
						<p className="text-xl text-white/80 max-w-2xl mx-auto">
							Learn sorting algorithms, tree traversals, and core data structures through interactive visualizations and hands-on coding practice.
						</p>
